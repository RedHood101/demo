...
public class StreamAudioVideoController {
    ...
    public static final String VIDEO_PATH = "/static/videos";  // put the path of videos folder
    public static final String AUDIO_PATH = "/static/audios"; // put the path of audios folder
